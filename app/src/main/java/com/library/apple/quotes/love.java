...
public class love extends Fragment{
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.love,container,false);

        MobileAds.initialize(getActivity(), "ca-app-pub-8750480772839804~5657654976");

        AdView adView = new AdView(getActivity());
        adView.setAdSize(AdSize.SMART_BANNER);
        adView.setAdUnitId("ca-app-pub-8750480772839804/1647091925");

        mAdView = myView.findViewById(R.id.adView_love);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        animationView = (LottieAnimationView)myView.findViewById(R.id.av_love);
        animationView.setAnimation("love.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);
        fab = (FloatingActionButton) myView.findViewById(R.id.fab_love);





        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_love);
        ...
        final FirebaseRecyclerAdapter<Contact,love.BlogViewHolder> recyclerAdapter=new FirebaseRecyclerAdapter<Contact,love.BlogViewHolder>(
                Contact.class,
                R.layout.row,
            ...
            @Override
            protected void populateViewHolder(final love.BlogViewHolder viewHolder, final Contact model, final int position) {
