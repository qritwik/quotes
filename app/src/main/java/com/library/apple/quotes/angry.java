...
public class angry extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.angry,container,false);
        ...
        adView.setAdUnitId("ca-app-pub-8750480772839804/7824136399");

        mAdView = myView.findViewById(R.id.adView_angry);
        ...
        animationView = (LottieAnimationView)myView.findViewById(R.id.av_angry);
        animationView.setAnimation("poi.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);
        fab = (FloatingActionButton) myView.findViewById(R.id.fab_angry);



        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_angry);
        ...
        myref= FirebaseDatabase.getInstance().getReference().child("angry");
        ...
        final FirebaseRecyclerAdapter<Contact,angry.BlogViewHolder> recyclerAdapter=new FirebaseRecyclerAdapter<Contact,angry.BlogViewHolder>(
                Contact.class,
                R.layout.row,
                angry.BlogViewHolder.class,
                myMostViewedPostsQuery
        ) {

            @Override
            protected void populateViewHolder(final angry.BlogViewHolder viewHolder, final Contact model, final int position) {
