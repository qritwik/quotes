...
public class morning extends Fragment{
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.morning,container,false);
        ...
        adView.setAdUnitId("ca-app-pub-8750480772839804/5262386389");

        mAdView = myView.findViewById(R.id.adView_morning);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        animationView = (LottieAnimationView)myView.findViewById(R.id.av_morning);
        animationView.setAnimation("love.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);
        fab = (FloatingActionButton) myView.findViewById(R.id.fab_morning);





        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_morning);
        ...
        myref= FirebaseDatabase.getInstance().getReference().child("morning");
        ...
        final FirebaseRecyclerAdapter<Contact,morning.BlogViewHolder> recyclerAdapter=new FirebaseRecyclerAdapter<Contact,morning.BlogViewHolder>(
                Contact.class,
                R.layout.row,
                morning.BlogViewHolder.class,
                myMostViewedPostsQuery
        ) {

            @Override
            protected void populateViewHolder(final morning.BlogViewHolder viewHolder, final Contact model, final int position) {
