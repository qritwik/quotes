...
public class student extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.student,container,false);

        MobileAds.initialize(getActivity(), "ca-app-pub-8750480772839804~5657654976");

        AdView adView = new AdView(getActivity());
        adView.setAdSize(AdSize.BANNER);
        adView.setAdUnitId("ca-app-pub-8750480772839804/5289240884");

        mAdView = myView.findViewById(R.id.adView_student);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        animationView = (LottieAnimationView)myView.findViewById(R.id.av_student);
        animationView.setAnimation("poi.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);
        fab = (FloatingActionButton) myView.findViewById(R.id.fab_student);




        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_student);
        ...
        final FirebaseRecyclerAdapter<Contact,student.BlogViewHolder> recyclerAdapter=new FirebaseRecyclerAdapter<Contact,student.BlogViewHolder>(
                Contact.class,
                R.layout.row,
                student.BlogViewHolder.class,
                myMostViewedPostsQuery
        ) {

            @Override
            protected void populateViewHolder(final student.BlogViewHolder viewHolder, final Contact model, final int position) {
