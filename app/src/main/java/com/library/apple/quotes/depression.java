...
public class depression extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.depression,container,false);

        MobileAds.initialize(getActivity(), "ca-app-pub-8750480772839804~5657654976");

        AdView adView = new AdView(getActivity());
        adView.setAdSize(AdSize.SMART_BANNER);
        adView.setAdUnitId("ca-app-pub-8750480772839804/2886546627");

        mAdView = myView.findViewById(R.id.adView_depression);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        animationView = (LottieAnimationView)myView.findViewById(R.id.av_dep);
        animationView.setAnimation("dep.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);

        fab = (FloatingActionButton) myView.findViewById(R.id.fab_dep);




        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_dep);
        ...
        myref= FirebaseDatabase.getInstance().getReference().child("depression");
        myref.keepSynced(true);

        Query myMostViewedPostsQuery = myref.orderByChild("name");


        final FirebaseRecyclerAdapter<Contact,depression.BlogViewHolder> recyclerAdapter=new FirebaseRecyclerAdapter<Contact,depression.BlogViewHolder>(
                Contact.class,
                R.layout.row,
                depression.BlogViewHolder.class,
                myMostViewedPostsQuery
        ) {

            @Override
            protected void populateViewHolder(final depression.BlogViewHolder viewHolder, final Contact model, final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        depression.this.startActivity(intent);
