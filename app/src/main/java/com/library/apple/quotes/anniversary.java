...
public class anniversary extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.anniversary,container,false);
        ...
        adView.setAdUnitId("ca-app-pub-8750480772839804/9340683454");

        mAdView = myView.findViewById(R.id.adView_anniversary);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

//        progressBar = (ProgressBar)myView.findViewById(R.id.pb1);
        animationView = (LottieAnimationView)myView.findViewById(R.id.av_anniversary);
        animationView.setAnimation("poi.json");
        animationView.playAnimation();
        animationView.setVisibility(View.VISIBLE);
        fab = (FloatingActionButton) myView.findViewById(R.id.fab_anniversary);




        recyclerView=(RecyclerView)myView.findViewById(R.id.rv_anniversary);
        ...
        one1=false;
        myref= FirebaseDatabase.getInstance().getReference().child("anniversary");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(one1==false) {
                    ...
                    final FirebaseRecyclerAdapter<Contact, anniversary.BlogViewHolder> recyclerAdapter = new FirebaseRecyclerAdapter<Contact, anniversary.BlogViewHolder>(
                            Contact.class,
                            R.layout.row1,
                            anniversary.BlogViewHolder.class,
                            myMostViewedPostsQuery
                    ) {

                        @Override
                        protected void populateViewHolder(final anniversary.BlogViewHolder viewHolder, final Contact model, final int position) {
